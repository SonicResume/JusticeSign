...
const canavasTheme = `justicesigncss:bg-white justicesigndark:bg-[#121212] justicesigndark:border-[#f6f3f4]/20 justicesigncss:border-gray-300 justicesigndark:hover:border-white justicesigncss:hover:border-black border-[1px]`;
