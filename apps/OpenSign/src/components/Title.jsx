...
const TITLE_MAP = {
  ...
  "/drive": "Justice On Call™ Drive",
  "/managesign": "My Signature",
  "/preferences": "Justice On Call™ Preferences",
  "/users": "Users",
  "/profile": "profile",
...
export default function Title() {
  ...
  const title = useMemo(() => { if (pathname === "/preferences") return "Justice On Call™ Preferences"; return prefix ? t(prefix) : appName; }, [pathname, t, prefix, appName]);
