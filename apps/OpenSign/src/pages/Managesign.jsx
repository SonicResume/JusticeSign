          ...
          <div className="flex flex-col md:flex-row gap-2 md:gap-5">
            ...
            <div>
              ...
              <div
                ...
                className="mystampCanvas justicesigndark:bg-[#1f2937] cursor-pointer border-[2px] justicesigncss:border-[#888] justicesigndark:border-[#4b5563] rounded-box flex flex-col overflow-hidden w-full h-full aspect-[5/2] justify-center items-center mr-2"
              >
                {stamp ? (
                  <img
                    alt="signature"
