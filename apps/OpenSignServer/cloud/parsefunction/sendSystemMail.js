...
async function sendMailProvider(req) {
  ...
  const reportMsg = `<p style="font-size: 13px; color:grey; text-align: center;">If you have questions about this email or believe you received it in error, please contact Justice Document Sign support.</p>`;
